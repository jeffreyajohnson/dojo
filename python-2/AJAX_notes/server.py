...
def new_note():
	...
	query = "INSERT INTO notes (title, description, created_at, updated_at) VALUES ('{}', '{}', NOW(), NOW())".format(request.form['note_title'], request.form['new_note'])
	mysql.query_db(query)

	query = "SELECT * FROM notes"
	notes = mysql.query_db(query) 
	
	return render_template("partials/notes_p.html", notes=notes)
...
def notes_edit(id):
	...
	return render_template("notes_p.html", notes=notes)
